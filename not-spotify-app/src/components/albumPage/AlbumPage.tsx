...
import { getArtistProfile, getFullDiscography } from "../../assets/api-calls/artist";
import { getDominantColor } from '../../assets/helpers/colorPalette';

import { IAlbum, IAlbumList, IArtist } from "../../assets/helpers/interfaces/objectInterfaces";
