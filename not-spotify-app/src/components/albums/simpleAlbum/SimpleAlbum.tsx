...
import { ISimpleAlbumProps } from '../../../assets/helpers/interfaces/propsInterfaces';
...
const SimpleAlbum: React.FC<ISimpleAlbumProps> = ({ album, clickLink }) => {
  return (
    <>
    {
      album ? (
        <>
          <div className="album-card responsive-card col-6 col-sm-4 col-md-3 col-lg-2 p-2">
            ...
            <div className="album-text-container text-container">
              <h6 className="page-link mt-3 mb-0">{album.name}</h6>
